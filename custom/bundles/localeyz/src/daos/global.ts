 ...
 */
const uploadImage = async (keys: string, imageId: string, field: string, service: any): Promise<any> => {
 ...
 */
const fetchData = async (urlField: string, imageField: string, service: any, chunkSize: number, offset: number) => {
